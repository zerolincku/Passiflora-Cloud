...
import com.zerolinck.passiflora.iam.mapper.SysPermissionMapper;
...
import com.zerolinck.passiflora.model.iam.mapperstruct.SysPermissionConvert;
import com.zerolinck.passiflora.model.iam.vo.SysPermissionTableVo;
import com.zerolinck.passiflora.model.iam.vo.SysPermissionVo;
        ...
        Map<String, List<SysPermissionTableVo>> menuMap =
                this.listByUserIds(CurrentUtil.requireCurrentUserId()).stream()
                        ...
                        .collect(Collectors.groupingBy(
                                com.zerolinck.passiflora.model.iam.vo.SysPermissionTableVo::getPermissionParentId,
                                Collectors.toList()));
        // 顶层菜单
