...
dependencies {
    ...
    constraints {
        ...
        api("com.mybatis-flex:mybatis-flex-core:1.11.4")
        api("com.mybatis-flex:mybatis-flex-spring-boot3-starter:1.11.4")
        api("com.mybatis-flex:mybatis-flex-processor:1.11.4")
