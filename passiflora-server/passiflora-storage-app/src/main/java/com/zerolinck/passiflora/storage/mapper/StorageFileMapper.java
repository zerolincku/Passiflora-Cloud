...
public interface StorageFileMapper extends BaseMapper<StorageFile> {
    ...
    int deleteByIds(@Nonnull @Param("fileIds") Collection<String> fileIds, @Nonnull @Param("updateBy") String updateBy);
    ...
    int confirmFile(@Nonnull @Param("fileIds") Collection<String> fileIds, @Nonnull @Param("updateBy") String updateBy);
}
