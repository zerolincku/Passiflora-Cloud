...
public interface SysDictApi {
    ...
    @GetMapping("page")
    Result<ListWithPage<SysDict>> page(QueryCondition<SysDict> condition);

    @Operation(summary = "新增")
    @PostMapping("add")
    Result<String> add(@RequestBody @Validated(Insert.class) SysDict sysDict);
    ...
    @GetMapping("detail")
    Result<SysDict> detail(@RequestParam(value = "dictId") String dictId);
